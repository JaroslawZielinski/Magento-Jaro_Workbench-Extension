...
/**
 * Class Jaro_MyScript_Adminhtml_NewsController
 */
class Jaro_MyScript_Adminhtml_NewsController extends Mage_Adminhtml_Controller_Action
{
    /**
     *
     */
    ...
    public function massDeleteAction()
    {
        ...
        $this->_redirect('*/adminhtml_news/index');
    }
    ...
    public function saveAction()
    {
        ...
        if ($postData = $this->getRequest()->getPost()) {
            ...
            if ($redirectBack) {
                $this->_redirect('*/adminhtml_news/new');
                return;
            }
        }
        $this->_redirect('*/adminhtml_news/index');
    ...
    public function deleteAction()
    {
        if ($id = $this->getRequest()->getParam('id')) {
            ...
            $this->_redirect('*/adminhtml_news/edit', array('id' => $id));
            return;
        }
...
// go to grid
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('admin/jaro/jaro_myscript_adminhtml_news');
    }
}
